...
| 5 — Ghostty pane MVP | readiness passed 2026-08-03; in progress | All five open questions resolved (see the phase's block below and `docs/phase-5-readiness.md`). Sequenced: `ControlInteractivity` interface promotion **first** (hard prerequisite — it drives input), then `termio-external`, then `GhosttyControlCore`. |
